...
(function($) {
    ...
    Slider.prototype = {
        ...
        bindDragEvent: function() {
            ...
            $handle.on('mousedown touchstart', null, mousedownHandler);
            ...
            function mousedownHandler(event) {
                downX = event.type == 'mousedown' ? event.clientX : event.touches[0].clientX;
                $(document).on('mousemove touchmove', null, mousemoveHandler);
                $(document).on('mouseup touchend', null, mouseupHandler);
            }

            function mousemoveHandler(event) {
                var moveX = event.type == 'mousemove' ? event.clientX : event.touches[0].clientX;
            ...
            function mouseupHandler(event) {
                ...
                $(document).off('mousemove touchmove', null, mousemoveHandler);
                $(document).off('mouseup touchend', null, mouseupHandler);
            }
            ...
            function success() {
                ...
                $handle.off('mousedown touchstart', null, mousedownHandler);
                $(document).off('mousemove touchmove', null, mousemoveHandler);
                setTimeout(function() {
